...
class AlphaNumComparator2Test extends Specification {


	static AlphaNumComparator alphaNumComparator = null;
	...
	def "Mutiple cases"() {
		...
		compToZero (first, second, comparison) == true
